...
client.on('message', message => {
    if (message.content === 'lungs') {
        const embed = new Discord.RichEmbed()
           ...
           .addFIeld("After Absorbing Oxygen", "Oxygen from the inhaled air passes through the alveoli walls and into the blood, after absorbing oxygen blood leaves lungs and carries to heart, the heart then pumps blood through body to provide oxygen to cells of tissues and organs, inhalation and exhalation are the processes the body brings in oxygen and breathe out carbon dioxide, the process is helped by a large dome-shaped muscle under the lungs called the diaphragm");
